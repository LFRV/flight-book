...
class PilotsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pilot" do
    assert_difference('Pilot.count') do
      post pilots_url, params: { pilot: { birth: @pilot.birth, firstname: @pilot.firstname, secondname: @pilot.secondname } }
    end
  ...
  test "should update pilot" do
    patch pilot_url(@pilot), params: { pilot: { birth: @pilot.birth, firstname: @pilot.firstname, secondname: @pilot.secondname } }
